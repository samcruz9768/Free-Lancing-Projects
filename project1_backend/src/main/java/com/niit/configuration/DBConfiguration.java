...
public class DBConfiguration {
	...
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{CustomerOrder.class,Product.class,Category.class,Customer.class,Authorities.class,BillingAddress.class,Cart.class,ShippingAddress.class,User.class,CartItem.class};
